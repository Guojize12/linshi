...
{
    if(++user_send.g_send_max[0]<MAX_TIME) //ʹЧ
    {
...
{
    if(++user_send.g_send_max[1]<MAX_TIME) //ʹЧ
    {
...
{
    if(++user_send.g_send_max[2]<MAX_TIME) //ʹЧ
    {
...
{
    if(++user_send.g_send_max[3]<MAX_TIME) //ʹЧ
    {
...
{
    if(++user_send.g_send_max[4]<MAX_TIME) //ʹЧ
    {
